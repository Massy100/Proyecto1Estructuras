...
class VentanaGestion(Toplevel):
    def __init__(self, parent):
        ...
        tk.Button(self, text="Mostrar Asociados", command=self.mostrar_lista_asociados).pack(side=tk.TOP, pady=5)
        tk.Button(self, text="Eliminar Cuenta por Nombre", command=self.eliminar_cuentas).pack(pady=5)
    ...
    def mostrar_lista_asociados(self):
        ...
        tree = tk.ttk.Treeview(ventana_lista, columns=("Código", "Nombre", "Dirección", "Teléfono", "DPI", "NIT", "Referencias"), show="headings")
        ...
        if seleccionado:  # Verifica que haya algo seleccionado
            ...
            def guardar_cambios(datos_actualizados):
                try:
                    ...
                    nuevos_valores = (datos_actualizados["Código"], datos_actualizados["Nombre"], datos_actualizados["Dirección"], datos_actualizados["Teléfono"], datos_actualizados["DPI"], datos_actualizados["NIT"], referencias_str)
